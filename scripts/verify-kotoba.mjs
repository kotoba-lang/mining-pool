...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("mining-pool bounded-vardiff Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("mining-pool Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("mining-pool Wasm main mismatch");

console.log("mining-pool: bounded vardiff Web/Wasm conformance passed");
